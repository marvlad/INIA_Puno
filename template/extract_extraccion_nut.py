...
OUTPUT_CSV = "Extraccion_Nut.csv"

# Try both names in case the accent is different in Excel
...
def cell_value_to_text(value):
    """
    Convert Excel cell values safely for CSV.
    """
...
def find_sheet_name(wb):
    """
    Find the correct sheet name even if accents differ slightly.
    """
...
def extract_sheet_to_csv(
    ...
    try:
        ...
        # utf-8-sig helps Excel open Spanish accents correctly
